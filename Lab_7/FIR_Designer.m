...
switch lower(filterType)
    case {'high','hpf','h'}
        ...
        %  If the filter length is even then add 1/2 to the two center samples
        %  If its even then add 1 to the center sample
        ...
        if mod(filterLength,2) == 1
            ...
            %  Even kernel length
            deltaFcn( filterLength/2 ) = 0.5;
            deltaFcn( filterLength/2 + 1 ) = 0.5;
