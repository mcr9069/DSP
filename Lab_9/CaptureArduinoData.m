...
%
% 'GraphDelay' -- The number of samples of delay between each graph
%              refresh.  This prevents MATLAB serial port over run when
%              numerous graphs are being plotted.  50 is a good starting
%              value.
%
...
defaultGraphDelay = 50;  %  Default delay between updates to the graphs
